...
use shred::{RunNow, System};

use crate::Dispatcher;
use crate::dispatcher::{SystemId, ThreadLocal};
use crate::stage::StagesBuilder;
...
/// # #![allow(unused)]
/// #
/// # extern crate system_graph;
/// # #[macro_use]
/// # extern crate shred_derive;
/// # use shred::{Read, System};
/// # use system_graph::{Dispatcher, DispatcherBuilder};
/// # #[derive(Debug, Default)] struct Res;
/// # #[derive(SystemData)] #[allow(unused)] struct Data<'a> { a: Read<'a, Res> }
/// # struct Dummy;
/// # impl<'a> System<'a> for Dummy {
...
impl<'a, 'b> DispatcherBuilder<'a, 'b> {
    ...
    pub fn build(self) -> Dispatcher<'a, 'b> {
        use crate::dispatcher::new_dispatcher;
...
impl<'b> DispatcherBuilder<'static, 'b> {
    ...
    pub fn build_async<R>(self, res: R) -> ::dispatch::async_dispatcher::AsyncDispatcher<'b, R> {
        use crate::async_dispatcher::new_async;
